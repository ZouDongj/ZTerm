...
await type('herdr --session zterm-b2vis\r', 3000);
...
await val(`ipcRenderer.send('pty-input', { tabId: '${sshTabId}', data: 'herdr --session zterm-b2vis kill 2>/dev/null; echo K\\r' })`);
ws.close();
process.exit(0);
