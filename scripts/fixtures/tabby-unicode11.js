// Read-only comparison fixture extracted from the installed Tabby terminal plugin.
// MIT license and exact provenance: ./TABBY-UNICODE11.md.
// The upstream bundle below is unchanged apart from LF normalization.
(function (root, nodeModule) {
    const module = { exports: {} };
    // BEGIN EXTRACTED TABBY UNICODE11
!function (e, t) {
  ...
  var e = {
      433: (e, t, i) => {
        ...
        function d(e, t) {
          ...
          for (; s >= r;) if (i = r + s >> 1, e > t[i][1]) r = i + 1;else {
            if (!(e < t[i][0])) return !0;
            s = i - 1;
          }
          return !1;
  ...
  return (() => {
    ...
    // END EXTRACTED TABBY UNICODE11
    root.__tabbyUnicode11 = module.exports;
    if (nodeModule) nodeModule.exports = module.exports;
